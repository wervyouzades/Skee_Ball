...
#define SEMI_GAMES 2 //amount of games needed to win semifinal
#define FINALS_GAMES 3 //amount of games needed to win final
...
int playgame(Player player, int scoretobeat = 0) {//returns score if game is over, or 0 otherwise
  if (waitreset + RESET_WAIT_TIME < millis() && digitalRead(RESET_PIN)) resetgame();
  if (game == 1) {
